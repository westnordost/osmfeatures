...
Add [`de.westnordost:osmfeatures:4.1`](https://mvnrepository.com/artifact/de.westnordost/osmfeatures/4.1) as a Maven dependency or download the jar from there.

For Android, use [`de.westnordost:osmfeatures-android:4.1`](https://mvnrepository.com/artifact/de.westnordost/osmfeatures-android/4.1).

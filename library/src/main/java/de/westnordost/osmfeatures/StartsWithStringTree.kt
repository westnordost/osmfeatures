...
@JvmOverloads constructor(strings: Collection<String>, maxDepth: Int = 16, minContainerSize: Int = 16) {
    ...
    private class Node(val children: Map<Char, Node>?, strings: Collection<String>) {
        val strings: Collection<String>? = strings
    ...
    companion object {
        private fun buildTree(
            ...
            val remainingStrings: Collection<String> = stringsByCharacter[null]!!
        ...
        private fun getStringsByCharacter(
            strings: Collection<String>,
            nth: Int
        ): Map<Char?, MutableCollection<String>> {
